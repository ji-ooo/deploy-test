	...
	<main>
		<div class="main-container-big _2">
			<form @submit.prevent="submitForm" class="searchForm">
				<div class="form-inner">
					<div class="input-container">
						<div class="input-titlecont">
							<label for="search-box" class="shihtzu-tinytitle">영화 <strong>검색</strong></label>
                ...
                <input id="search-box" type="text" placeholder="영화 제목으로 찾아보세요" v-model="searchQuery">
		...
		<div ref="bottomDiv">
			<div class="main-container _1">
				<div class="boxoffice-container">
					<p class="boxoffice-title">
						<strong>| 상영중</strong> 영화
					</p>
					<div v-if="nowPlayingMovies.length"  class="carousel-container2">
						<Carousel :itemsToShow="5" :wrapAround="false" :transition="1000" :pauseAutoplayOnHover="true">
...
const submitForm = async () => {
	...
	// 	return
	// }
	const result = await store.searchMovies(searchQuery.value, selectedGenre.value);
